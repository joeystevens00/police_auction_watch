...
def check_auctions(args: AuctionArgs):
    ...
    with webdriver.Firefox(options=opts) as driver:
        ...
        item_link = latest_item.find_element_by_css_selector('.product-name-category a')
        ...
        return {"name": item_name, "time_remaining": time_remaining,  "last_price": last_price, 'link': item_link.get_attribute('href')}
